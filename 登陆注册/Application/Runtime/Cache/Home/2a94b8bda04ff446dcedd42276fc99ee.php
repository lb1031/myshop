...
<?php
$catModel = D('Admin/Category'); $navData = $catModel->getNavData(); ?>
<!-- 头部 start -->
	<div class="header w1210 bc mt15">
		...
		<div class="nav w1210 bc mt10">
			<!--  商品分类部分 start-->
			<div class="category fl<?php if(!$show_nav) echo' cat1'; ?>"> <!-- 非首页，需要添加cat1类 -->
				<div class="cat_hd<?php if(!$show_nav) echo' off'; ?>">  <!-- 注意，首页在此div上只需要添加cat_hd类，非首页，默认收缩分类时添加上off类，鼠标滑过时展开菜单则将off类换成on类 -->
					<h2>全部商品分类</h2>
					<em></em>
				</div>
				
				<div class="cat_bd<?php if(!$show_nav) echo' none'; ?>">
				...
				<div class="goodslist_wrap">
					...
					<div <?php if($k1>0) echo 'class="none"'; ?>>
						<ul>
							...
							<li>
								<dl>
									<dt><a href="<?php echo U('goods?id='.$v2['id']); ?>"><?php showImage($v2['sm_logo']); ?></a></dt>
