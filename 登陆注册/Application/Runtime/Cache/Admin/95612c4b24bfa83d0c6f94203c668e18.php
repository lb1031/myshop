    ...
    <form method="post" action="<?php echo U('add'); ?>" enctype="multipart/form-data" >
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="cat_name" size="60" maxlength="60" value="" />
                    <span class="require-field">*</span>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="radio" name="is_rec" value="是" /> 推荐
                    <input type="radio" name="is_rec" value="否" checked="checked" /> 不推荐
                </td>
            </tr>
            <tr>
