    ...
    <form name="main_form" method="POST" action="/index.php/Admin/Role/edit/id/1.html" enctype="multipart/form-data" >
        ...
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td>
                	<?php foreach ($priData as $k => $v): if(in_array($v['id'], $priId)) $check = 'checked="checked"'; else $check = ''; ?>
                    <?php echo str_repeat('-', $v['level']*8); ?><input <?php echo $check; ?> type="checkbox" name="pri_id[]" value="<?php echo $v['id']; ?>" /><?php echo $v['pri_name']; ?><br />
                    <?php endforeach; ?>
                </td>
            </tr>
            <tr>
